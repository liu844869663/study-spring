...
public class UtilCollectionInjectionTest {

	public static void main(String[] args) {
		
		String configLocations = "classpath:collection/util-collection-injection.xml" ;
		
		AbstractApplicationContext container = new ClassPathXmlApplicationContext(configLocations);
		
		System.out.println( container.getBean( "set" ) );
